---
title: "AQI Part 2 - Customize Graphs"
filters: 
  - webr
  - naquiz
...
This tutorial uses air quality data from [the EPA](https://aqs.epa.gov/aqsweb/airdata/download_files.html#AQI) ranging from 2000-2023, and has data on all counties in the United States. The Air Quality Index (AQI) is calculated by looking at various pollutants including Particle Pollution (PM2.5 and PM10), Carbon Monoxide, Lead, Nitrogen Dioxide, Ozone, and Sulfur Dioxide. Here is a [link to the data](https://aqs.epa.gov/aqsweb/airdata/download_files.html#AQI) and here is a [link to more information](https://aqs.epa.gov/aqsweb/airdata/FileFormats.html#_pollutant_standards) about the data. 
...
-   [make another tile plot and choose your own location(s)](#sec-tilemylocation) 
...
Click "Continue" to make a scatter plot of the AQI over time in any location!
...
myScatterplotData |>
  ...
  labs(title = paste0("Days with AQI value ", myLevel, " 2000-2023 in ", myCounty, " and ", myCounty2),
       x = "Year",
       y = paste0("Number of days with AQI value ", myLevel))+
  scale_x_continuous(breaks = seq(2000,2023, by=2))
...
After graphing, you may wonder why the graph looks like it does. Here, you can look at your raw data. 

### Choose a county 

First, you'll need to choose a county that you want to graph. See section [Choose a county](#sec-choosecounty) to see a list of county options.

After choosing a county, you'll tell the computer which county you chose.
...
Note: If this code doesn't work, it's because you haven't chosen a county in a previous step. Return to [Choose a county](#sec-choosecounty) and run the code to choose your county. 
:::
