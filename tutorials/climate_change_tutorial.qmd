...
filters:
  - webr
editor: visual
author: Written by Finn Watson, edited for web version by Olivia Spagnuolo
---
...
url<- "https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/files/data/owid_co2_data_2.csv"
download.file(url, "co2Data.csv")
#Pulls data that has been loaded into the github repo. 
...
url<- "https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/files/data/temp_data.csv"
...
![https://physicsworld.com/a/solving-climate-change-with-jonathan-koomey-and-ian-monroe/](https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/files/figures/climateimage.jpg){height=4in}
...
![https://geographicbook.com/temperature/](https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/files/figures/temperature.jpg){height=3in}
:::
:::
...
```{webr-r}
ggplot(data=co2Data, mapping=aes(x=.data[[XVar]], y=.data[[YVar]]))+
...
![from.giphy.com](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ3IyeWw4a3ZjZTZ3bWhqOW5lbndxcDZ6dW9zMTEyd2Z4bmxjeG5odiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/93uYptVAHE7C0/giphy.gif)
