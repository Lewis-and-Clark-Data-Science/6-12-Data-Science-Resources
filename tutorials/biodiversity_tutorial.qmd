...
[Fun Fact:]{.underline} Posit Cloud is like a fancy calculator
...
[Answer:]{.underline} 12 columns and 148 Rows
...
[Answer:]{.underline} The `index` and `numspecies` columns!
...
[Answer]{.underline}: There are two Biomes in this Data Set; Temperate Coniferous Forest and Tropical Forest.
...
[Answer:]{.underline}There are two different taxa in this data set; Terrestrial Plants and Terrestrial Invertebrates.
...
-   This should be either `numspecies` if your graph is looking at the number of species or `index` if your graph is looking at Biodiversity Index
    ...
    **NOTE:** In this part it important to NOT include quotations `""`.
    ...
    -   [Example:]{.underline} `y=variable` or `ggplot(aes(x= YEAR, y=numspecies))`
