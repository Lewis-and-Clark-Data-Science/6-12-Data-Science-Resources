...
We want to create separate graphs for each biome and species. 

**Stop and Think:**

*What are the options for biome and species?*
...
Look at the code chunk right below this. You will eventually change this code based on your assigned graph. Here's a preview of the final code. We will walk through step by step how to edit it for your groups' graph.

DO NOT **Press** the green play button yet, the code chunk will not run!
