...
author: Grace Kazmir, edited for web version by Olivia Spagnuolo
filters: 
  - webr
  - naquiz
df-print: kable
...
![from.https://www.newscientist.com/definition/biodiversity/](https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/files/figures/biodiversityimage.jpg){cap-location="margin" height=2in}
:::
:::
...
Here's [a video](https://www.youtube.com/watch?v=7DOuku8876I) to learn more about biodiversity and how we can calculate it using Simpson's Diversity Index.
...
{{< video https://www.youtube.com/watch?v=IuyFDz0VA70&list=TLGGNH2RFY9J5t0wNzA4MjAyNA&t=131s >}}
...
We are going to be using data from [BioTIME,](https://biotime.st-andrews.ac.uk){target="_blank"} which is a database with a focus on biodiversity. They include free open-access data in an effort to make data more accessible and usable by anyone. 
...
-   (Go back and look at the `Biodiversity_Index` data set to try to find the answer)
...
Let's use R to solve this question instead! The `unique()` function lists unique values within a column, so it shows us all the **distinct** values in a column.
...
**Type** in the name of your Biome and Taxa. Replace the red line ______ and don't delete the quotes `""`. Make sure you spell everything correct and use the exact capitalization in the dataset! 
...
-   Recall the column names for each of these variables: `index` and `numspecies`. 
...
Biodiversity_Index|>
  ...
  ggplot(aes(x=.data[["YEAR"]], y=.data[[yvar]])) + 
...
3.  *What other kind of data would you like to look at in the future?*
...
![From.giphy.com](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExaWhhZnlpMjFmanJ2NG5hajBjbWxyYzVtdmkzMDJqcGN5bjg0b2xmYiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/ely3apij36BJhoZ234/giphy-downsized-large.gif)
...
![from giphy.com](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXJ5b3RzY2RwbjV4N3prcHZldjZkMGVlc2NodGZuMXU5cHZnMHF4ZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o6fJ1BM7R2EBRDnxK/giphy.gif)
</div>
