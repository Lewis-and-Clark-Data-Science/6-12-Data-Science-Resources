...
**Note to teachers** At this point I recommend you check out [THIS PRESENTATION](https://docs.google.com/presentation/d/1Y7wV1RD7vIZekLII6g6N3B1gyEcbyqoUPD5KLykXRNM/edit#slide=id.g2ece6933889_0_659){target="_blank"} to explore what the graphs mean in your class. Additionally, click to the end of this tutorial to see other graphs for different locations and species. 
...
<button id="continue-button" class="btn btn-primary float-start me-2">Learn more!</button>
</div>
...
-   Additionally check out the [linked lesson plans](https://lewis-and-clark-data-science.github.io/6-12-Data-Science-Resources/tutorials/salmon_tutorial.html) for more resources to teach about salmon and the Bonneville Dam.
:::
::: {.column-width=50%}
![From.giphy.com](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExdXJiNXJrZ3Q1enUzeHdkdWw1ODBiMzV4Y3Nhc3Rmdm84amdnNW1uOSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/yVCajDohhJFq8/giphy.gif)
:::
:::
