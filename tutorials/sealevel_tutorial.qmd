...
Now we're going to use commands to learn more about sea level. As we learned, scientists use satellites and water level gauges to measure the sea level. They collect all those numbers and it becomes **data**. 
...
Let's start by focusing on Astoria and create a scatter plot. A scatter plot will plot a point for each individual data entry. We can also add a line of best fit to see the overall trend of how sea level is changing. 
